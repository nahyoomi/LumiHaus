    ...
    <section aria-label="Product Filters" className="mb-8 px-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex gap-4">
          <FilterButton label="New" filter="new" selectedFilter={selectedFilter} onFilterChange={onFilterChange} />
          <FilterButton label="Trendy" filter="trendy" selectedFilter={selectedFilter} onFilterChange={onFilterChange} />
          <FilterButton label="Sales" filter="sales" selectedFilter={selectedFilter} onFilterChange={onFilterChange} />
        </div>
